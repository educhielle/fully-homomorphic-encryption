...
#define ROW_LEN KEYLEN/COL_LEN

// std::vector<uint8_t>
// AES_ECB_decrypt(const std::vector<uint8_t> &, const std::vector<uint8_t> &);

std::vector<uint8_t>
AES_ECB_encrypt(const std::vector<uint8_t> &, const std::vector<uint8_t> &);
